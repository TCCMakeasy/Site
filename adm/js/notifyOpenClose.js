...
const abrirNotify = (id_professor) => {
  notify.showModal();
  atualizarNotificacoes(id_professor);
};
...
const atualizarNotificacoes = async (id_professor) => {
  const response = await fetch(
    "./includes/atualizarNotificacoes.php?id_professor=" + id_professor
  );
