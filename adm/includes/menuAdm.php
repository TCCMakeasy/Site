...
$contaMensagem = "SELECT COUNT(id_notifica) FROM notifica WHERE id_professor = '" . $_SESSION['id'] . "' AND verifica_notifica = 1";
...
<aside id="menu">
    ...
    <div id="fotoMenu">
        ...
        <p class="nomeAdm" id="nomeMenuAdm"><?php $nome = explode(' ', $_SESSION['nome']);
                                            echo $nome[0]; ?></p>
    </div>
    <div id="scroll">
        <nav>
