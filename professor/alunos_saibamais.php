        ...
        <div id="container">
            ...
            <div id="conteúdo">
                ...
                if($sqlAluno['telefone_aluno'] != ""){
                    ...
                    echo '</label></div>';
                    echo '<a href="https://api.whatsapp.com/send?phone=5511951456142&amp;text=Ol%C3%A1%2C%20estava%20vendo%20o%20site%20de%20voc%C3%AAs%20e%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es." target="_blank" id="whatsapp">';
                    echo '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-whatsapp" viewBox="0 0 16 16">';
