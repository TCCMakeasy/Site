        ...
        <div id="container">
            ...
            <div id="conteúdo">
                ...
                if($infosProfessor['telefone_professor'] != ""){
                    ...
                    echo '<a href="https://api.whatsapp.com/send?phone=55'; echo $telefoneFormatado; echo '&amp;text=Olá, sou o '; echo $_SESSION['nome']; echo ', seu professor da Makeasy English, gostaria de conversar." target="_blank" id="whatsappProfessor">';
