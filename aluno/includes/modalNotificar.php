...
<dialog id="notificações">
    <div class="notificações-content">
        ...
        <?php
                ...
                $result_notifica = "SELECT * FROM notifica where id_aluno = '" . $_SESSION['id'] . "' AND  verifica_notifica '0'";
                ...
                while ($row_usuario = mysqli_fetch_assoc($resultado_notify)) {
                    ...
                    echo '<a href="./includes/excluir_msn.php?id_notifica='.$row_usuario['id_notifica'].'">';
