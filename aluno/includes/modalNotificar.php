<link rel="stylesheet" type="text/css" href="/aluno/styles/estiloNotificar.css">
<div id="fadeNotificar"></div>
<div id="notificações">
    <div class="notificações-content">
        <div class="notificações-header">
            <button id="closeNotificar"><img src="/aluno/images/voltarseta.png" alt="Botão para voltar"></button>
        </div>
        <div class="notificações-body">
            <div class="notificação">
                <p id="notificações-txt">ahjkfhjsadhffids sidjhflsdf dfs sdfdsfsdfs</p><span class="separaItens">|</span>
